    ...
    return (
        <Column style={{ justifyContent: 'center', paddingHorizontal: 28, }}>
            ...
            <Row style={{ justifyContent: 'space-between', alignItems: 'center', }}>
                ...
                <Button onPress={() => { modalPix.current?.close() }} style={{ width: 42, height: 42, borderRadius: 100, backgroundColor: color.secundary + 20, justifyContent: 'center', alignItems: 'center', }}>
