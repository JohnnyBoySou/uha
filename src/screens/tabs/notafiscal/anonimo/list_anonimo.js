...
export default function NotafiscalListAnonimoScreen({ navigation, route }) {
    ...
    return (
        <Main style={{ backgroundColor: '#fff', }}>
            ...
            <Row style={{ justifyContent: 'space-between', alignItems: 'center', marginHorizontal: 28, top: 40, }}>
    ...
    return (
        <MotiView from={{ opacity: 0, }} animate={{ opacity: 1, }} transition={{ type: 'timing', duration: 300 }} style={{ justifyContent: 'center', alignItems: 'center', padding: 12, }}>
            <Column style={{ justifyContent: 'center', alignItems: 'center', marginVertical: 20, }}>
                ...
                <Button  style={{ paddingHorizontal: 32, marginTop: 30, paddingVertical: 18, borderRadius: 100, backgroundColor: color.secundary,  alignSelf: 'center', }} onPress={() => navigation.navigate('NotafiscalSendAnonimo')} >
