    ...
    return (
        <Main style={{ backgroundColor: "#fff", }}>
            ...
            <Column>
                <CameraView
                    ...
                    onBarcodeScanned={(data) => {
                        navigation.navigate('NotafiscalVerifyAnonimo', { nota: data.data, origin: origin, type: type, })
                    }}>
                </CameraView>
            ...
            <MotiView from={{ opacity: 0, }} animate={{ opacity: 1, }} exit={{ opacity: 0, }} style={{ position: 'absolute', justifyContent: 'space-between', bottom: 35, left: 35, right: 35, }}>
                <Row style={{ alignSelf:'center', backgroundColor: '#ffffff40', borderRadius: 8, marginBottom: 20, paddingVertical: 10, paddingHorizontal: 18, alignItems: 'center',  }}>
                ...
                <Button onPress={() => { navigation.navigate('NotafiscalListAnonimo', { origin: origin, type: type, }) }} style={{ borderRadius: 100,  marginVertical: 12, alignSelf: 'flex-start' }}>
            ...
            <BottomSheet ref={modalDigitNota} snapPoints={[0.1, 360]} keyboardBlurBehavior handleIndicatorStyle={{ backgroundColor: "#d7d7d7", width: 80, height: 8, }}>
                <Column style={{ marginHorizontal: margin.h, }}>
                    ...
                    <ButtonPR onPress={() => { navigation.navigate('NotafiscalVerifyAnonimo', { nota: value, origin: origin, type: type, }); Keyboard.dismiss(); modalDigitNota?.current?.close() }} style={{ marginVertical: 12, marginHorizontal: 32, }}>
