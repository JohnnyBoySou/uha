        ...
        <Main style={{ backgroundColor: '#fff', }}>
            ...
            <Scroll>
                ...
                <Column style={{ marginHorizontal: margin.h, flexGrow: 1, }}>
                    <Button style={{ paddingHorizontal: 32, paddingVertical: 18, borderRadius: 100, backgroundColor: color.secundary, alignSelf: 'center', }} onPress={() => navigation.navigate('NotafiscalSend')} >
...
export const MessageSuccess = () => {
    ...
    return (
        <MotiView from={{ opacity: 0, }} animate={{ opacity: 1, }} exit={{ opacity: 0, }} style={{ justifyContent: 'center', alignItems: 'center', }}>
            ...
            <Button onPress={() => { navigation.navigate('NotafiscalList') }} style={{ paddingVertical: 18, borderRadius: 100, paddingHorizontal: 52, marginTop: 16, backgroundColor: color.primary, }}>
