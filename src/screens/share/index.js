            ...
            <Scroll style={{ paddingBottom: 30, }}>
                ...
                <Row style={{ marginVertical: 20, marginLeft: 28, }}>
                    ...
                    <Column style={{ width: 180, borderRadius: 12, backgroundColor: color.secundary, }}>
                        <MotiImage source={require('@imgs/share1.png')} style={{ width: 140, height: 150, borderRadius: 12, }} />
                ...
                <Column style={{ marginHorizontal: margin.h, }}>
                    <Title style={{ marginTop: 24, fontSize: 22, marginBottom: 8, }}>Conheça a campanha</Title>
                    ...
                    <Title style={{ marginTop: 24, fontSize: 22, marginBottom: 8, }}>Como participar</Title>
