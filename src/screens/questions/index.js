        ...
        <Main style={{ backgroundColor: color.background, }}>
            <Scroll>
                ...
                <Column style={{ marginHorizontal: margin.h, marginVertical: 20,}}>
                    ...
                    <Button onPress={handleSend} style={{ backgroundColor: color.primary, paddingVertical: 12, paddingHorizontal: 20, borderRadius: 100, marginTop: 30, marginBottom: 12, }}>
                        <Label style={{ color: '#fff', fontSize: 16, textAlign: 'center', fontFamily: font.bold, }}>Enviar</Label>
                    </Button>
                    <ButtonOut onPress={() => {navigation.navigate('QuestionList')}}  style={{ borderColor: color.secundary, }}>
                        <LabelLI style={{  fontSize: 16, color: color.secundary, }}>Verificar registros</LabelLI>
                    </ButtonOut>
                </Column>
